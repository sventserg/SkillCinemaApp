...
//    }
    ...
    override suspend fun searchMovieByCountryAndGenre(
        ...
        try {
            val response = SearchRetrofit.searchApi.searchMovieByCountryAndGenre(
                countries, genres, order,
...
//    }
    ...
    override suspend fun searchMovieByCountry(
        ...
        try {
            val response = SearchRetrofit.searchApi.searchMovieByCountry(
                countries, order, type,
                ratingFrom, ratingTo, yearFrom,
                yearTo, keyword, page
            )
...
//    }
    ...
    override suspend fun searchMovieByGenre(
        ...
        try {
            val response = SearchRetrofit.searchApi.searchMovieByGenre(
                genres, order, type,
                ratingFrom, ratingTo, yearFrom,
                yearTo, keyword, page
            )
...
//    }
    ...
    override suspend fun searchMovie(
        ...
        try {
            val response = SearchRetrofit.searchApi.searchMovie(
                order, type, ratingFrom,
...
//    override suspend fun searchPersonByName(name: String, page: Int): PersonByNameList? {
//        try {
//            val response = SearchRetrofit.searchApi.searchPersonByName(name, page)
//            return if (response.isSuccessful) response.body() else null
//        } catch (t: Throwable) {
//            Log.e(RETROFIT_TAG, "${t.message}")
//            return null
