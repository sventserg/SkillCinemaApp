package com.example.skillcinema.presentation.adapter.filter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.skillcinema.databinding.ItemFilterNameBinding
...
class MovieFilterAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieFilterViewHolder {
        val binding = ItemFilterNameBinding.inflate(LayoutInflater.from(parent.context))
