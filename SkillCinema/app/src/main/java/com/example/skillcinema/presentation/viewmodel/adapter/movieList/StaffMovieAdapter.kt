...
import com.example.skillcinema.presentation.viewmodel.adapter.movieList.MovieListViewHolder

class StaffMovieAdapter(
    private val movieList: List<PersonMovie>
) : RecyclerView.Adapter<MovieListViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieListViewHolder {
        val binding = MoviePreviewBinding.inflate(LayoutInflater.from(parent.context))
